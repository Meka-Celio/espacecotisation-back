...
if (isset($_GET['CINMedecin'])) {
    ...
    $numrecu                        =   explode(',', $_GET['numrecu']); //array or not
    $montant                        =   explode(',', $_GET['montant']); //array or not
    $somme                          =   explode(',', $_GET['somme']); //array or not
    $annee                          =   explode(',', $_GET['annee']); //array or not
    $numcommande                    =   $_GET['numcommande'];
    $secteur                        =   $_GET['secteur'];
    $specialite                     =   $_GET['specialite'];
    $date_diplome                   =   $_GET['date_diplome'];
    $date_installation_recrutement  =   $_GET['date_installation_recrutement'];
    $daterecu                       =   $_GET['daterecu'];
    $adresse_pro                    =   $_GET['adresse_pro'];
    $msg = "addCotOk";
    ...
    try {
        ...
        $mail->addBCC('contact@cnom.ma', 'Contact Espace Cotisation');     //Add a recipient
        ...
        $mail->Body    = "
            <!DOCTYPE html>
                    ...
                    <p style='margin: 0; font-size: 14px; mso-line-height-alt: 32px;'><span style='font-size:16px;'>Secteur <strong>: $secteur  </strong>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Specialite <strong>: $specialite <br/></strong></span></p>
        ...
        header("Location:../test.send.php?msg=$msg&CINMedecin=$CINMedecin&NumTransaction=$numcommande");
    } 
    catch (Exception $e) {
